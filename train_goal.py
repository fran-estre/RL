...
from env_goal import QuadrupedEnv
import os
...
def make_env(render_mode, log_dir, rank):
    ...
    def _init():
        ...
        env = Monitor(
            env,
            filename=os.path.join(log_dir, f"env_{rank}", "monitorgoal.csv"),
...
if __name__ == "__main__":
    ...
    try:
        ...
        model.save("laikago_goal_interrupt")
        print("✅ Modelo guardado como 'laikago_goal'")
        vec_env.close()
        print("Entrenamiento completado. Logs en 'logs/env_*'/monitor.csv")
